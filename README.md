...
一个使用 Expo 构建的现代化 React Native 应用程序，具有先进的 UI 组件和动画效果,该项目为个人展示项目。
...
npx run expo start
打包(需登录eas)
eas build -p android --profile production/development
eas build -p ios --profile production/development
