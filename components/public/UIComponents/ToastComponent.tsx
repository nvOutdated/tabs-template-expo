      ...
      render: ({ id }) => {
        return (
          <Toast 
            action="success" 
            variant="solid"
            className={`w-80 mt-10 py-2 ${getBackgroundColor('success')} ${getBorderColor('success')} border-2 rounded-lg shadow-lg z-50`}
          >
      ...
      render: ({ id }) => {
        return (
          <Toast 
            action="error" 
            variant="solid"
            className={`w-80 mt-10 py-2 ${getBackgroundColor('error')} ${getBorderColor('error')} border-2 rounded-lg shadow-lg z-50`}
          >
            <View className="flex-row items-center gap-2 px-3 py-1">
              {getIcon('error')}
              <View className="flex-1 flex-col">
      ...
      render: ({ id }) => {
        return (
          <Toast 
            action="warning" 
            variant="solid"
            className={`w-80 mt-10 py-2 ${getBackgroundColor('warning')} ${getBorderColor('warning')} border-2 rounded-lg shadow-lg z-50`}
          >
            <View className="flex-row items-center gap-2 px-3 py-1">
              {getIcon('warning')}
              <View className="flex-1 flex-col">
      ...
      render: ({ id }) => {
        return (
          <Toast 
            action="info" 
            variant="solid"
            className={`w-80 mt-10 py-2 ${getBackgroundColor('info')} ${getBorderColor('info')} border-2 rounded-lg shadow-lg z-50`}
          >
            <View className="flex-row items-center gap-2 px-3 py-1">
              {getIcon('info')}
              <View className="flex-1 flex-col">
