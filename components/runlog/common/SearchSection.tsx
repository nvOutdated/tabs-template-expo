      ...
      <View className="bg-background-100 py-3 px-4 border-b border-tertiary-100">
        <View className="flex-row justify-between items-center">
          <View style={styles.searchItem}>
            ...
            <View
              style={[styles.searchInput, { minWidth: 200 }]}
            ...
            >
              <TextInput
                ...
                className="h-8 text-left  align-middle text-typography-900"
                placeholder="搜索设备..."
              ...
              <View style={styles.timeInputGroup}>
                ...
                >
                  <Text className="text-tertiary-900 text-sm">
                    {tempStartDate
                      ? transferDate(tempStartDate.getTime())
                      : "选择日期"}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                <TouchableOpacity onPress={clearStartTime} className="p-2">
                  <Ionicons name="close-circle" size={20} color="#999" />
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View style={styles.timeRow}>
              ...
              <View style={styles.timeInputGroup}>
                ...
                >
                  <Text className="text-tertiary-900 text-sm">
                    {tempEndDate
                      ? transferDate(tempEndDate.getTime())
                      : "选择日期"}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                <TouchableOpacity onPress={clearEndTime} className="p-2">
                  <Ionicons name="close-circle" size={20} color="#999" />
                </TouchableOpacity>
              </View>
            </View>
