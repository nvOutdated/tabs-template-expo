...
type CollectionAreaDrawerProps = {
    visible: boolean;
    onClose: () => void;
    areas: Area[];
    selectedArea: Area;
    ...
    devices: Device[]; // Required for collection drawer
};
...
export default function CollectionAreaDrawer({
    visible,
    onClose,
    areas,
    selectedArea,
    ...
    const listData = useMemo(() => {
        const flattenData = (area: Area, level: number = 0) => {
            ...
            const hasChildren = (area.children && area.children.length > 0) || areaDevices.length > 0;
    ...
    }, [areas, expandedAreas, devices, searchText]);
